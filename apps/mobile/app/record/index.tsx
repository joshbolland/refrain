...
import { createRecordingUploadPayloadFromUri } from '../../lib/recordingUpload';
...
export default function RecordScreen() {
  ...
  const handleSave = async () => {
    try {
      ...
      const upload = await createRecordingUploadPayloadFromUri({
        recordingId: id,
        uri: finalUri,
        createdAt: now,
      });
      const media = await recordingRepo.uploadMedia(upload);
